<?php
    ...
    $result = mysqli_query($conn, $sqlDatabase);
    ...
    $result = mysqli_query($conn, $sqlServices);
    ...
    $result = mysqli_query($conn, $sqlQueries);
